...
/*
    ...
    SPANISH
        ...
        En caso de no querer mostrar nada en ese canal basta con asignar 0 para que el canal no sea escrito.
...
void draw()
{
    if (dataComplete == true)
    {
        ...
        yPos = yEdge;
        for (int n = 0; n < 16; n++) // this will draw a last orizonal line
        {
            if (PinArduinoNames[n] != 0) // draw only used pins
            {
                s = str(PinAssignment[n]);
                ...
                if (xPos[n] == 0)
                {
                    if (isLowInit[index1][index2] == true)
                    {
                        line(xPos[n] + xShift, yPos + 30, xEnd + xShift, yPos + 30);
                    }
                    else
                    {
                        line(xPos[n] + xShift, yPos, xEnd + xShift, yPos);
                    }
                }
            }
            yPos += 36;
